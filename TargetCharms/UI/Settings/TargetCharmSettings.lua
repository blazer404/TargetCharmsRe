...
function TargetCharms_RegisterTargetSettings(category, layout, RIGHT, customLayoutMode, CUSTOM_LAYOUT, FindPresetPattern)
    ...
    local tcEnabledSetting = Settings.RegisterProxySetting(
            category,
            "TC_ENABLED",
    ...
    do
        local s = Settings.RegisterProxySetting(
                ...
                "TC_SHOWTARGET",
                Settings.VarType.Boolean,
                TARGETCHARMS_OPTIONS_SHOWONTARGET,
                true,
    ...
    do
        local s = Settings.RegisterProxySetting(
                ...
                "TC_TOGGLE",
                Settings.VarType.Boolean,
                TARGETCHARMS_OPTIONS_TOGGLEICON,
                false,
        ...
        local s = Settings.RegisterProxySetting(
                ...
                function()
                    return customLayoutMode["TargetCharms"] and CUSTOM_LAYOUT
                            or FindPresetPattern(TC_DEFAULT_LAYOUTS_CHARMS, TargetCharms_Options["TargetCharms"]["buttonTemplate"])
                            or CUSTOM_LAYOUT
                end,
                function(v)
    ...
    do
        ...
        init:AddShownPredicate(function()
            return customLayoutMode["TargetCharms"]
                    or not FindPresetPattern(TC_DEFAULT_LAYOUTS_CHARMS, TargetCharms_Options["TargetCharms"]["buttonTemplate"])
        end)
